...
<head>
    <style type='text/css'>
        ...
        a {text-decoration: none;color: #edac7f;}
        p,div,h1 {text-align:center;font-weight:bold}
    	div p{color:#f5ecec;display:inline-block;width:50%;word-break: break-word;vertical-align: middle;float: left;padding-top: 15px;font-size:24px;direction:rtl;}
    	h1{color:#23104f;}
