...
<head>
    <style type='text/css'>
    	...
    	div p{color:#f5ecec;display:inline-block;width:50%;word-break: break-word;vertical-align: middle;float: left;padding-top: 15px;font-size:25px;direction:rtl;}
    	h1{color:#23104f;}
        ...
        <div>
            ...
            <div style="width:60%;float: left;">
                ...
                <article>
                    ...
                    نتیجه ی حاصل
                    <br>
                    <?= (!empty($data['info']['result'])?$data['info']['result']:'ندارد') ?>
                </article>
            </div>
        </div>
    <?php } ?>
